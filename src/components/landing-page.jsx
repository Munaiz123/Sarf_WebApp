  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      <main className="flex-1 snap-y snap-mandatory overflow-y-scroll">
        <section className="flex items-center justify-center md:px-6 px-4 h-[80dvh] snap-start">
          <div className="space-y-8 text-center max-w-[700xpx]">
            ...
            <h1 className="text-4xl font-bold tracking-tighter ">Financial Wellness For All</h1>
